...
class Rectangle():
    ...
    def __str__(self):
        ...
        if self.__width == 0 or self.__height == 0:
            return ''
        return '\n'.join(map(lambda x: str(self.print_symbol) * self.__width,
                             range(self.__height)))
    ...
    def bigger_or_equal(rect_1, rect_2):
        '''returns the larger rectangle based on the area'''
    ...
    def square(cls, size=0):
        '''
        returns new rectangle instance(square)
        based on whether: h, w = size
        '''
